...
const craftMap = {
shield_wood: 0, shield_stone: 1, shield_gold: 2, shield_diamond: 3, shield_adamant: 4,
ammo_arrow: 5, ammo_bolt: 6, ammo_bullet: 7
};
const categories = {
Shields: ['shield_wood', 'shield_stone', 'shield_gold', 'shield_diamond', 'shield_adamant'],
Ammunition: ['ammo_arrow', 'ammo_bolt', 'ammo_bullet']
};
...
if (item.key === 'showfps') fpsEl.style.display = features.showfps.enabled ? 'block' : 'none';
...
if (key === 'showfps') fpsEl.style.display = f.enabled ? 'block' : 'none';
